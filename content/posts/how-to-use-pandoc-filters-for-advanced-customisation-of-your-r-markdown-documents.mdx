...
slug: "how-to-use-pandoc-filters-for-advanced-customisation-of-your-r-markdown-documents"
---
...
I could use the syntax ```` ```block
 
```` in the chunk options to create a [custom block](https://bookdown.org/yihui/bookdown/custom-blocks.html).
